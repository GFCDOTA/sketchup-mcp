...
## Generated: 2026-05-29T19:51:09Z
...
| # | Verdict | Findings |
|---|---|---|
| canonical | WARN_documented | 0 findings (artifacts\review\planta_74\gpt_bridge_smoke_20260529T195038Z\final) |
...
| status | `ok` |
| question_file | `.ai_bridge\questions\20260529T195053Z_oracle_pass_but_known_warnings.md` |
| response_file | `.ai_bridge\responses\20260529T195053Z_oracle_pass_but_known_warnings.md` |
| decision | `merge` |
...
|---|---|---|
| `wall_fidelity` | WARN | All walls are correctly aligned and continuous. | Downgraded by known_warnings_carried for this fixture. |
| `door_fidelity` | PASS | All doors are correctly aligned and openable. |
| `window_fidelity` | PASS | All windows are correctly aligned and openable. |
| `room_fidelity` | WARN | All rooms are correctly defined and connected. | Downgraded by known_warnings_carried for this fixture. |
| `scale_rotation` | PASS | The model is correctly scaled and oriented. |
| `global_visual` | PASS | The model is visually consistent and free of major discrepancies. |
...
- `artifacts\review\planta_74\gpt_bridge_smoke_20260529T195038Z\final/model_top.png`
- `artifacts\review\planta_74\gpt_bridge_smoke_20260529T195038Z\final/model_iso.png`
- `artifacts\review\planta_74\gpt_bridge_smoke_20260529T195038Z\final/side_by_side_pdf_vs_skp.png`
