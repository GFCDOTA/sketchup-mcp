...
- score: cama_parede_limpa=30, simetria_criados=20, circulacao=20, tapete=10, cama_com_cabeceira=5, banco_dresser=5
...
- móveis:
  ...
  - **dresser** (dresser) 0.4×1.6 m @(19.06,22.69) parede `m019` — comoda baixa em parede livre, sem competir com guarda-roupa
