...
## Generated: 2026-05-29T20:03:08Z
...
| # | Verdict | Findings |
|---|---|---|
| canonical | WARN_documented | 0 findings (artifacts\review\planta_74\gpt_bridge_smoke_20260529T200235Z\final) |
...
| status | `ok` |
| question_file | `.ai_bridge\questions\20260529T200250Z_oracle_pass_but_known_warnings.md` |
| response_file | `.ai_bridge\responses\20260529T200250Z_oracle_pass_but_known_warnings.md` |
| decision | `merge` |
...
|---|---|---|
| `wall_fidelity` | WARN | All walls appear correctly aligned and continuous. | Downgraded by known_warnings_carried for this fixture. |
| `door_fidelity` | PASS | Doors are correctly placed and aligned. |
| `window_fidelity` | PASS | Windows are correctly placed and aligned. |
| `room_fidelity` | WARN | Rooms are correctly defined and aligned. | Downgraded by known_warnings_carried for this fixture. |
| `scale_rotation` | PASS | The scale and rotation of the model are consistent with the PDF. |
| `global_visual` | PASS | The overall visual representation is accurate and consistent with the PDF. |
...
- `artifacts\review\planta_74\gpt_bridge_smoke_20260529T200235Z\final/model_top.png`
- `artifacts\review\planta_74\gpt_bridge_smoke_20260529T200235Z\final/model_iso.png`
- `artifacts\review\planta_74\gpt_bridge_smoke_20260529T200235Z\final/side_by_side_pdf_vs_skp.png`
