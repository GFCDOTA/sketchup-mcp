...
## Generated: 2026-06-02T04:11:11Z
...
| # | Verdict | Findings |
|---|---|---|
| 0 | WARN | 0 findings (runs\grade_align\attempt_0) |
...
- `runs\grade_align\final/model_top.png`
- `runs\grade_align\final/model_iso.png`
- `runs\grade_align\final/side_by_side_pdf_vs_skp.png`
