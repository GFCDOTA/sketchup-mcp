...
## 12. 2026-05-21 — Frente 3: Floor_r001 split (SB extension + Voronoi)

After Frente 2 shipped the diagnostic harness, the user mandated a
conservative, testable, reversible fix for the Floor_r001 merge
identified in Categoria B. Two opt-in layers, applied in order:
